...
function PizzaBlock({ title, price, types, imageUrl, sizes }) {
  const thicknessPizza = ["традиционное", "тонкое"];

  let [quantityСart, setQuantityСar] = useState(0);
  let [statusThickness, setStatusThickness] = useState(0);
  ...
  return (
    <div className="pizza-block">
      ...
      <button
        ...
        onClick={() => setQuantityСar(quantityСart + 1)}
      >
